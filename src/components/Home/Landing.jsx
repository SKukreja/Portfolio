...
const Name = styled.h1`
    font-family: 'Christopher Robin', 'adobe-garamond-pro', sans-serif;
    font-weight: 700;
    width: 80vw;
    font-size: 7vw;
    color: var(--black);
