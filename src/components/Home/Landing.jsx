...
// Styled components for the Landing section
...
// Landing component
const Landing = memo(({ $isMobile }) => {
  return (
    <Scene>
      <SceneText>
        <Intro><AnimatedText startImmediately={1} text="Hi, my name is" /></Intro>
        <NameContainer>
        ...
        <Intro aria-label="Introduction"><AnimatedText startImmediately={1} text="I'm a full-stack developer with a passion for creating unique digital experiences." /></Intro>
        <ActionButtons initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 3 }}>
